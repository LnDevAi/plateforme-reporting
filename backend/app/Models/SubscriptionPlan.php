...
class SubscriptionPlan extends Model
{
    ...
    const AVAILABLE_FEATURES = [
        ...
        'elearning_access' => 'Accès aux formations',
        'basic_courses' => 'Cours de base',
        'advanced_courses' => 'Cours avancés',
        'expert_courses' => 'Cours experts',
        'certification_programs' => 'Programmes de certification',
        'custom_learning_paths' => 'Parcours d\'apprentissage personnalisés',
        'progress_tracking' => 'Suivi de progression',
        'certificates_download' => 'Téléchargement certificats',
        'learning_analytics' => 'Analytics d\'apprentissage',
        'instructor_support' => 'Support instructeur',
        'webinar_access' => 'Accès aux webinaires',
